...
const Learning: React.FC = (props: object) => {
    const playlists = [
        ...
        },
        {
            ...
            img:
                'https://seeklogo.com/images/K/koa-logo-D494764315-seeklogo.com.png',
        },
        {
            topic: 'StencilJS',
            url:
            ...
            img:
                'https://www.javascripttuts.com/images/technologies/Stencil.png',
        },
        {
            topic: 'SvelteJS',
            url:
        ...
        },
        {
            ...
            img:
                'https://miro.medium.com/max/3200/1*DiNIG4Bfpm65_wwXf_JwMA.png',
        },
        {
        ...
        },
        {
            ...
            img:
                'https://miro.medium.com/max/2560/1*c9qLloy5Ts-lzAVkd3vgeA.png',
        },
        {
            topic: 'Python/Django',
            url:
